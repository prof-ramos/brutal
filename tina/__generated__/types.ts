...
export type Blog = Node & Document & {
  ...
  humorLevel?: Maybe<Scalars['String']['output']>;
  relatedSigns?: Maybe<Array<Maybe<Scalars['String']['output']>>>;
...
export type BlogBodyAstrologyCardFilter = {
  title?: InputMaybe<StringFilter>;
  description?: InputMaybe<StringFilter>;
  zodiacSign?: InputMaybe<StringFilter>;
};

export type BlogBodyHumorBreakFilter = {
  text?: InputMaybe<StringFilter>;
  style?: InputMaybe<StringFilter>;
};

export type BlogBodyFilter = {
  AstrologyCard?: InputMaybe<BlogBodyAstrologyCardFilter>;
  HumorBreak?: InputMaybe<BlogBodyHumorBreakFilter>;
};
...
export type BlogFilter = {
  ...
  humorLevel?: InputMaybe<StringFilter>;
  relatedSigns?: InputMaybe<StringFilter>;
...
export type BlogMutation = {
  ...
  zodiacSign?: InputMaybe<Scalars['String']['input']>;
  targetAudience?: InputMaybe<Scalars['String']['input']>;
  humorLevel?: InputMaybe<Scalars['String']['input']>;
  relatedSigns?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  relatedPosts?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  body?: InputMaybe<Scalars['JSON']['input']>;
};

export type BlogPartsFragment = { __typename: 'Blog', title: string, description: string, pubDate: string, updatedDate?: string | null, author: string, category?: string | null, tags?: Array<string | null> | null, readingTime?: number | null, difficulty?: string | null, heroImage?: string | null, heroImageAlt?: string | null, draft?: boolean | null, featured?: boolean | null, zodiacSign?: string | null, targetAudience?: string | null, humorLevel?: string | null, relatedSigns?: Array<string | null> | null, relatedPosts?: Array<string | null> | null, body?: any | null };
...
export type BlogQuery = { __typename?: 'Query', blog: { __typename: 'Blog', id: string, title: string, description: string, pubDate: string, updatedDate?: string | null, author: string, category?: string | null, tags?: Array<string | null> | null, readingTime?: number | null, difficulty?: string | null, heroImage?: string | null, heroImageAlt?: string | null, draft?: boolean | null, featured?: boolean | null, zodiacSign?: string | null, targetAudience?: string | null, humorLevel?: string | null, relatedSigns?: Array<string | null> | null, relatedPosts?: Array<string | null> | null, body?: any | null, _sys: { __typename?: 'SystemInfo', filename: string, basename: string, hasReferences?: boolean | null, breadcrumbs: Array<string>, path: string, relativePath: string, extension: string } } };
...
export type BlogConnectionQuery = { __typename?: 'Query', blogConnection: { __typename?: 'BlogConnection', totalCount: number, pageInfo: { __typename?: 'PageInfo', hasPreviousPage: boolean, hasNextPage: boolean, startCursor: string, endCursor: string }, edges?: Array<{ __typename?: 'BlogConnectionEdges', cursor: string, node?: { __typename: 'Blog', id: string, title: string, description: string, pubDate: string, updatedDate?: string | null, author: string, category?: string | null, tags?: Array<string | null> | null, readingTime?: number | null, difficulty?: string | null, heroImage?: string | null, heroImageAlt?: string | null, draft?: boolean | null, featured?: boolean | null, zodiacSign?: string | null, targetAudience?: string | null, humorLevel?: string | null, relatedSigns?: Array<string | null> | null, relatedPosts?: Array<string | null> | null, body?: any | null, _sys: { __typename?: 'SystemInfo', filename: string, basename: string, hasReferences?: boolean | null, breadcrumbs: Array<string>, path: string, relativePath: string, extension: string } } | null } | null> | null } };
...
export const ExperimentalGetTinaClient = () =>
  getSdk(
    generateRequester(
      createClient({
        url: "https://content.tinajs.io/1.6/content/6fa78e8f-7811-4b8d-9f19-3ecf7cb0caed/github/main",
        queries,
      })
    )
  )
